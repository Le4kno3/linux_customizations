...
const base_url="https://api.etherscan.io/api?module=" + module_url + "&action=" + action_url + "&address=" + address_url + "&startblock=" + startblock + "&endblock=" + endblock + "&page=" + page_url + "&offset=" + offset_url + "&sort=" + sort_url + "&apikey=" + apikey_ethscan;
