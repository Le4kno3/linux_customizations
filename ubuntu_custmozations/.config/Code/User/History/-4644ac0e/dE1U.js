...
const root = "0x02446fb530b6910eeb393d46bc62ab36ddca2c8028366c87507ff3091172d6d1" //any hash value.
...
async function main() {
    ...
    const myHalbornToken = await HalbornToken.deploy(label, symobol, amount, deployer, );
