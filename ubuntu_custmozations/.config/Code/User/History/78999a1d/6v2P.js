...
describe("Contract: Token contract", function () {
    ...
    it("2. Should transfer tokens between accounts",
        async function(){
            ...
            console.log("Addr1's balance before transfer is: ", addr1Balance)
            ...
            //get balance of addr1, by calling "balanceOf()" function of the contract
            addr1Balance = await myToken.balanceOf(addr1.address);
            console.log("Addr1's balance after transfer is: ", addr1Balance)
        }
    );    
