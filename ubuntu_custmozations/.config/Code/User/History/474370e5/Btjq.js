...
describe("HalbornToken Contract Testing", function () {
    ...
    //         console.log("Sending 30 Tokens to Bob ...");
    //         console.log("Transferable balance tokens that Takshil before sending to Bob: ", (await myHalbornToken.calcMaxTransferrable(takshil.address)).toString())
    ...
    //         // UNCOMMENT to see the 2nd error.
    //         //send 30 Tokens to Martin
    //         console.log("");
    //         console.log("Transferable balance tokens that Takshil before sending to Martin: ", (await myHalbornToken.calcMaxTransferrable(takshil.address)).toString());
    //         tmp = ethers.utils.parseUnits("10", 18);
    //         await myHalbornToken.connect(takshil).transfer(martin.address, tmp);

            
    //         console.log("Sending 10 Tokens to Bob ...");
    //         tmp = ethers.utils.parseUnits("10", 18);
    ...
    //         console.log("Transferable balance tokens that Takshil after sending to Martin: ", (await myHalbornToken.calcMaxTransferrable(takshil.address)).toString());
    //     });
    // });
    
    describe("Verify setSigner", function () {

        it('check if setSigner works properly', async function () {
            console.log("Martin's address: ", martin.patil)
            await myHalbornToken.connect(takshil).setSigner(martin.address);
        });
    });
