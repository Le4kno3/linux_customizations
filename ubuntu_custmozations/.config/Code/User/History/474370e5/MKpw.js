...
describe("HalbornToken Contract Testing", function () {
    ...
    describe("Could Takshil transfer these unlocked tokens to Bob.", function () {
        ...
        it('Check Balances', async function () {
            ...
            //Note that "calcMaxTransferrable()", does not considers any token transfers, hence even if I have transfered 30 tokens to Bob, I am still able to see 500.337... tokens
