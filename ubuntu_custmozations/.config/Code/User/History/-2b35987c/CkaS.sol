...
contract HalbornToken is ERC20{
        ...
        public
    {
        ...
        // console.log("Current block.timestamp is: ", block.timestamp);
        // console.log("vestTime is: ", vestTime_);
        require(vestTime_ > block.timestamp - 1000, "vesting start must be in the future"); //adjusting block.timestamp to consider delay.
