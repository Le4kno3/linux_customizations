...
task("get-balance", "Reads the number")
  ...
  .setAction(async (taskArgs) => {
    ...
    let myHalbornToken = await new ethers.Contract(contractAddr, MyHalbornToken.interface, accounts[0])
...
// We require a provider to query the network
    ...
    let bal1 = myHalbornToken.connect(takshil).balanceOf(takshil.address);
    console.log("Balance of Takshil: ",contractWithSigner)
    ...
    // let myHalbornToken_steve = myHalbornToken.connect(steve);
