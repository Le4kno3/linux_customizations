...
const final_url="https://api-goerli.etherscan.io/api?module=" + module_url + "&action=" + action_url + "&address=" + address_url + "&startblock=" + startblock + "&endblock=" + endblock + "&page=" + page_url + "&offset=" + offset_url + "&sort=" + sort_url + "&apikey=" + apikey_ethscan;
...
receiveData().then((data) => console.log(data.result));
receiveData().then((data) => console.log(data.result.status));
